...
TTT_SCALE_ADAPTER_LR_MULT="${TTT_SCALE_ADAPTER_LR_MULT:-1.0}"
...
TTT_SURPRISE_GATE_ENABLED="${TTT_SURPRISE_GATE_ENABLED:-0}"
TTT_SURPRISE_GATE_FLOOR="${TTT_SURPRISE_GATE_FLOOR:-0.35}"
TTT_SURPRISE_GATE_TEMP="${TTT_SURPRISE_GATE_TEMP:-0.08}"
TTT_SURPRISE_GATE_EMA="${TTT_SURPRISE_GATE_EMA:-0.80}"
TTT_ROBUST_LOSS_ENABLED="${TTT_ROBUST_LOSS_ENABLED:-0}"
TTT_ROBUST_LOSS_CLIP="${TTT_ROBUST_LOSS_CLIP:-1.25}"
TTT_LOGIT_SCALE_ENABLED="${TTT_LOGIT_SCALE_ENABLED:-0}"
TTT_LOGIT_SCALE_LIMIT="${TTT_LOGIT_SCALE_LIMIT:-0.08}"
TTT_LOGIT_SCALE_LR_MULT="${TTT_LOGIT_SCALE_LR_MULT:-8.0}"
...
LOG_FILE="${LOG_FILE:-run_1953_scale_adapter_seed${SEED}_limit${TTT_SCALE_ADAPTER_LIMIT}_slr${TTT_SCALE_ADAPTER_LR_MULT}_rob${TTT_ROBUST_LOSS_ENABLED}_temp${TTT_LOGIT_SCALE_ENABLED}_sg${TTT_SURPRISE_GATE_ENABLED}_bias${TTT_DOC_BIAS_ENABLED}_prefix${PHASED_TTT_PREFIX_DOCS}.log}"
...
echo "  scale limit: $TTT_SCALE_ADAPTER_LIMIT lr_mult=$TTT_SCALE_ADAPTER_LR_MULT"
echo "  doc bias: $TTT_DOC_BIAS_ENABLED clip=$TTT_DOC_BIAS_CLIP lr_mult=$TTT_DOC_BIAS_LR_MULT"
echo "  surprise gate: $TTT_SURPRISE_GATE_ENABLED floor=$TTT_SURPRISE_GATE_FLOOR temp=$TTT_SURPRISE_GATE_TEMP ema=$TTT_SURPRISE_GATE_EMA"
echo "  robust loss: $TTT_ROBUST_LOSS_ENABLED clip=$TTT_ROBUST_LOSS_CLIP"
echo "  logit scale: $TTT_LOGIT_SCALE_ENABLED limit=$TTT_LOGIT_SCALE_LIMIT lr_mult=$TTT_LOGIT_SCALE_LR_MULT"
...
TTT_SCALE_ADAPTER_ENABLED=1 TTT_SCALE_ADAPTER_LIMIT="$TTT_SCALE_ADAPTER_LIMIT" TTT_SCALE_ADAPTER_LR_MULT="$TTT_SCALE_ADAPTER_LR_MULT" \
TTT_DOC_BIAS_ENABLED="$TTT_DOC_BIAS_ENABLED" TTT_DOC_BIAS_CLIP="$TTT_DOC_BIAS_CLIP" TTT_DOC_BIAS_LR_MULT="$TTT_DOC_BIAS_LR_MULT" \
TTT_SURPRISE_GATE_ENABLED="$TTT_SURPRISE_GATE_ENABLED" TTT_SURPRISE_GATE_FLOOR="$TTT_SURPRISE_GATE_FLOOR" TTT_SURPRISE_GATE_TEMP="$TTT_SURPRISE_GATE_TEMP" TTT_SURPRISE_GATE_EMA="$TTT_SURPRISE_GATE_EMA" \
TTT_ROBUST_LOSS_ENABLED="$TTT_ROBUST_LOSS_ENABLED" TTT_ROBUST_LOSS_CLIP="$TTT_ROBUST_LOSS_CLIP" \
TTT_LOGIT_SCALE_ENABLED="$TTT_LOGIT_SCALE_ENABLED" TTT_LOGIT_SCALE_LIMIT="$TTT_LOGIT_SCALE_LIMIT" TTT_LOGIT_SCALE_LR_MULT="$TTT_LOGIT_SCALE_LR_MULT" \
