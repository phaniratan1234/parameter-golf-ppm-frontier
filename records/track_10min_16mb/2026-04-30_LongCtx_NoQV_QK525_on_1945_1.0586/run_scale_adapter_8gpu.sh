...
LOG_FILE="${LOG_FILE:-run_1953_scale_adapter_seed${SEED}_limit${TTT_SCALE_ADAPTER_LIMIT}_slr${TTT_SCALE_ADAPTER_LR_MULT}_sg${TTT_SURPRISE_GATE_ENABLED}_bias${TTT_DOC_BIAS_ENABLED}_prefix${PHASED_TTT_PREFIX_DOCS}.log}"
