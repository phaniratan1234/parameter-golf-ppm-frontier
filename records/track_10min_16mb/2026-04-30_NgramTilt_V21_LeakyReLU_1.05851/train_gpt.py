...
class Hyperparameters:
    ...
    ttt_scale_adapter_limit = float(os.environ.get("TTT_SCALE_ADAPTER_LIMIT", "0.02"))
...
class BatchedTTTLoRA(nn.Module):
    def __init__(
        self, bsz, model, rank, k_lora=True, mlp_lora=True, o_lora=True,
        scale_adapter=False, scale_limit=0.02,
    ):
        super().__init__()
        self.bsz = bsz
